...
{if $time_records}
  ...
  {foreach $time_records as $record}
    ...
    {/if}
          ...
          <td align="center">{if $record.approved || $record.timesheet_id || $record.invoice_id}&nbsp;{else}<a href="time_edit.php?id={$record.id}"><img class="table_icon" alt="{$i18n.label.edit}" src="../img/icon-edit.png"></a>{/if}</td>
          <td align="center">{if $record.approved || $record.timesheet_id || $record.invoice_id}&nbsp;{else}<a href="time_delete.php?id={$record.id}"><img class="table_icon" alt="{$i18n.label.delete}" src="../img/icon-delete.png"></a>{/if}</td>
        </tr>
  {/foreach}
      </table>
      <table border="0">
