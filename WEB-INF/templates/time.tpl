...
{if $time_records}
  ...
  {foreach $time_records as $record}
    ...
    {/if}
        <td align='right' valign='top'>{if $record.duration == '0:00' && $record.allow_empty_duration neq 1}<font color="#ff0000">{$i18n.form.time.uncompleted}</font>{else}{$record.duration}{/if}</td>
    ...
    {else}
      ...
      {if $record.duration == '0:00' && $record.allow_empty_duration neq 1}
