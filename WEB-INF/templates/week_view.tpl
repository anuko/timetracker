...
<table class="centered-table">
  ...
  <tr><td><div class="small-screen-form-control-separator"></div></td></tr>
  <tr class = "small-screen-label"><td><label for="notes">{$i18n.label.weekends}:</label></td></tr>
  <tr>
    <td class="large-screen-label"><label for="notes">{$i18n.label.weekends}:</label></td>
