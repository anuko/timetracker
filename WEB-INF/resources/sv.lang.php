...
'footer.contribute_msg' => 'Det finns flera olika sätt att bidra till Anuko Time Tracker.',
...
'error.sys' => 'Systemfel.',
'error.db' => 'Databasfel.',
'error.field' => 'Fältet för "{0}" innehåller ett felaktigt värde.',
'error.empty' => 'Fältet för "{0}" kan inte vara tomt.',
'error.not_equal' => 'Fältet för "{0}" matchar inte "{1}".',
'error.interval' => 'Fältet för "{0}" måste vara större än "{1}".',
'error.project' => 'Välj ett projekt.',
'error.task' => 'Välj en uppgift.',
...
'error.task_exists' => 'Det finns redan en uppgift med det här namnet.',
...
'error.no_invoiceable_items' => 'Det finns inga fakturerbara inlägg.',
...
'error.no_email' => 'Ingen e-post associerad med det här användarnamnet.',
'error.uncompleted_exists' => 'Ett oavslutat inlägg existerar redan. Avsluta eller ta bort det.',
'error.goto_uncompleted' => 'Visa oavslutat inlägg.',
'error.overlap' => 'Tidsintervallet överlappar med ett redan existerande inlägg.',
...
'button.add_task' => 'Lägg till uppgift',
...
'button.create_team' => 'Skapa arbetsgrupp',
...
'label.team_name' => 'Arbetsgruppsnamn',
...
'label.task' => 'Uppgift',
'label.tasks' => 'Uppgifter',
'label.description' => 'Beskrivning',
'label.start' => 'Starttid',
'label.finish' => 'Sluttid',
'label.duration' => 'Varaktighet',
'label.note' => 'Anteckning',
'label.item' => 'Utensilier',
'label.cost' => 'Kostnad',
'label.day_total' => 'Idag',
'label.week_total' => 'Denna veckan',
'label.month_total' => 'Denna månaden',
'label.today' => 'Idag',
...
'label.status' => 'Status',
'label.tax' => 'Skatt', // TODO: Eller är det moms?
...
'label.what_is_it' => 'Vad är det här?',
...
'title.time' => 'Tider',
'title.edit_time_record' => 'Redigera inlägg',
'title.delete_time_record' => 'Ta bort inlägg',
...
'title.tasks' => 'Uppgifter',
'title.add_task' => 'Lägg till uppgift',
'title.edit_task' => 'Redigera uppgift',
'title.delete_task' => 'Ta bort uppgift',
...
'form.login.about' =>'Anuko <a href="https://www.anuko.com/lp/tt_2.htm" target="_blank">Time Tracker</a> är en lättanvänd applikation byggd på öppen källkod för att spåra och hålla koll på arbetstider.',
...
'form.time.over_quota' => 'Över kvoten',

// Editing Time Record form. See example at https://timetracker.anuko.com/time_edit.php (get there by editing an uncompleted time record).
'form.time_edit.uncompleted' => 'Det här inlägget har sparats utan sluttid. Inget fel har uppstått.',
...
'form.reports.include_records' => 'Inkludera tidsinlägg',
'form.reports.include_billable' => 'Fakturerbara inlägg',
'form.reports.include_not_billable' => 'Inte fakturerbara inlägg',
'form.reports.include_invoiced' => 'Fakturerade',
'form.reports.include_not_invoiced' => 'Inte fakturerade',
...
'form.reports.group_by_task' => 'Uppgift',
...
'form.invoice.invoice_entries' => 'Kopplade inlägg',
...
'form.tasks.active_tasks' => 'Aktiva uppgifter',
'form.tasks.inactive_tasks' => 'Inaktiva uppgifter',
...
'form.client.client_to_delete' => 'Kund som raderas',
'form.client.client_entries' => 'Kopplade inlägg',
...
'form.profile.mode_projects_and_tasks' => 'Projekt och uppgifter',
'form.profile.record_type' => 'Inläggstyp',
...
'form.mail.footer' => 'Anuko Time Tracker är en lättanvänd applikation byggd på öppen källkod för att spåra och hålla koll på arbetstider. Besök <a href="https://www.anuko.com">www.anuko.com</a> för mer information.',
